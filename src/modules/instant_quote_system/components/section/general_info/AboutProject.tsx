...
const AboutProject = () => {
    ...
    return (
        <>
            <div className="w-full h-full flex py-6 px-2 flex-col items-center sm:justify-center gap-y-2 ">
                ...
                <div className='w-full h-full flex  flex-col p-2 overflow-auto gap-y-3 items-center relative'>
                ...
                <div className="w-full mb-8 sm:mb-0 sm:absolute relative sm:bottom-2 h-16 flex items-center px-4">
